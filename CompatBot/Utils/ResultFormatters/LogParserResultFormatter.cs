...
internal static partial class LogParserResult
{
    ...
    private static readonly Version NvidiaFullscreenBugVersion = new(400, 0);
    private static readonly Version NvidiaFullscreenBugFixedVersion = new(499, 99);
    private static readonly Version NvidiaTextureMemoryBugVersion = new(526, 0);
    private static readonly Version NvidiaTextureMemoryBugFixedVersion = new(526, 99);

    private static readonly Version AmdShaderCompilationBugVersion = new(26, 3, 1);
    private static readonly Version AmdShaderCompilationBugFixedVersion = new(26, 3, 2);
    ...
    private static void CleanupValues(LogParseState state)
    {
            ...
            && int.TryParse(gpuVramSizeStr, out var gpuVramSizeMb))
        {
            if (gpuVramSizeMb > 1024)
                gpuVramSizeMb = (int)(Math.Round(gpuVramSizeMb / 1024.0) * 1024);
    ...
    private static string? GetWindowsVersion(Version windowsVersion) =>
        windowsVersion.Major switch
        {
            ...
            10 => windowsVersion.Build switch
            {
                ...
                <28021 => "11 26H1 Canary Build " + windowsVersion.Build,
                <29500 => "11 26H1 Experimental Build " + windowsVersion.Build,
                <29566 => "11 26H2 Canary Build " + windowsVersion.Build,
